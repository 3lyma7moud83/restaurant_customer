...
class AppLocalizations {
  ...
  static const Map<String, Map<String, String>> _localizedValues = {
    'ar': {
      ...
      'common.minutes': 'د',
      'common.km_unit': 'كم',
      'common.distance_unknown': 'المسافة غير متاحة',
      'common.open_now': 'مفتوح الآن',
      'common.closed_now': 'مغلق الآن',
      ...
      'drawer.complaint': 'إرسال شكوى',
      'drawer.complaint_sent': 'تم إرسال الشكوى بنجاح.',
      'drawer.privacy': 'سياسة الخصوصية',
      'drawer.security': 'الحماية والأمان',
      'drawer.version': 'رقم الإصدار',
      'drawer.content_unavailable': 'المحتوى غير متاح حالياً.',
      'restaurant.opening_time': 'موعد الفتح',
      'restaurant.closing_time': 'موعد الغلق',
      'restaurant.address': 'العنوان',
      'restaurant.address_unavailable': 'العنوان غير متوفر',
      'complaint.heading': 'إرسال شكوى',
      'complaint.heading_with_restaurant': 'شكوى تخص {name}',
      'complaint.subtitle':
          'اكتب عنوانًا واضحًا ثم التفاصيل، وسيتم إرسال الشكوى للإدارة للمراجعة.',
      'complaint.title_label': 'عنوان الشكوى',
      'complaint.title_hint': 'مثال: تأخير شديد في التوصيل',
      'complaint.message_label': 'وصف الشكوى',
      'complaint.message_hint': 'اكتب وصف الشكوى هنا',
      'complaint.send': 'إرسال',
      'complaint.title_required': 'اكتب عنوان الشكوى أولاً.',
      'complaint.title_too_short': 'عنوان الشكوى يجب أن يكون أوضح قليلًا.',
      'complaint.message_required': 'اكتب وصف الشكوى أولاً.',
      'complaint.message_too_short': 'وصف الشكوى قصير جدًا.',
      'complaint.validation_error':
          'تحقق من بيانات الشكوى ثم حاول الإرسال مرة أخرى.',
      'complaint.login_required': 'سجل الدخول لإرسال الشكوى.',
      ...
      'menu.select_variant': 'اختر الحجم أو الوزن',
      ...
      'cart.delivery_address_hint': 'حدد عنوان التوصيل من الخريطة فقط',
      ...
      'cart.discount_section': 'كود الخصم',
      'cart.discount_code_label': 'كود الخصم',
      'cart.discount_code_hint': 'مثال: SAVE10',
      'cart.discount_apply': 'تطبيق',
      'cart.discount_remove': 'إلغاء الكود',
      'cart.discount_type': 'نوع الخصم: {type}',
      'cart.discount_type_percentage': 'نسبة مئوية',
      'cart.discount_type_fixed': 'مبلغ ثابت',
      'cart.discount_before': 'السعر قبل الخصم',
      'cart.discount_value': 'قيمة الخصم',
      'cart.discount_final': 'السعر النهائي',
      'cart.discount_apply_success': 'تم تطبيق الكود {code} بنجاح.',
      'cart.discount_empty_code': 'اكتب كود الخصم أولاً.',
      'cart.discount_invalid_or_expired': 'الكود غير صالح أو منتهي.',
      'cart.discount_min_order_not_met':
          'الحد الأدنى لتفعيل الكود هو {minimum}.',
      'cart.discount_invalid_amount': 'بيانات الخصم غير صالحة لهذا الكود.',
      'cart.discount_already_applied': 'تم تطبيق هذا الكود بالفعل.',
      'cart.discount_single_code_only':
          'يمكن تطبيق كود خصم واحد فقط. أزل الكود الحالي أولاً.',
      'cart.discount_removed_min_order':
          'تم إلغاء كود الخصم لأن الحد الأدنى هو {minimum}.',
      'cart.discount_error_generic':
          'تعذر التحقق من كود الخصم حالياً. حاول مرة أخرى.',
      'cart.discount_locked': 'لا يمكن تطبيق كود خصم أثناء وجود طلب جارٍ.',
    ...
    'en': {
      ...
      'common.minutes': 'min',
      'common.km_unit': 'km',
      'common.distance_unknown': 'Distance unavailable',
      'common.open_now': 'Open now',
      'common.closed_now': 'Closed now',
      ...
      'drawer.support': 'Technical Support',
      'drawer.complaint': 'Submit Complaint',
      'drawer.complaint_sent': 'Complaint submitted successfully.',
      'drawer.privacy': 'Privacy Policy',
      'drawer.security': 'Protection & Security',
      'drawer.version': 'App Version',
      'drawer.content_unavailable': 'Content is currently unavailable.',
      'restaurant.opening_time': 'Opening time',
      'restaurant.closing_time': 'Closing time',
      'restaurant.address': 'Address',
      'restaurant.address_unavailable': 'Address unavailable',
      'complaint.heading': 'Submit complaint',
      'complaint.heading_with_restaurant': 'Complaint for {name}',
      'complaint.subtitle':
          'Write a clear subject and details. Your complaint will be sent for review.',
      'complaint.title_label': 'Complaint title',
      'complaint.title_hint': 'Example: Major delay in delivery',
      'complaint.message_label': 'Complaint description',
      'complaint.message_hint': 'Write your complaint description here',
      'complaint.send': 'Send',
      'complaint.title_required': 'Please enter a complaint title first.',
      'complaint.title_too_short':
          'Complaint title is too short. Please add more details.',
      'complaint.message_required': 'Please enter complaint details first.',
      'complaint.message_too_short': 'Complaint description is too short.',
      'complaint.validation_error':
          'Please review complaint details and try again.',
      'complaint.login_required': 'Sign in to submit a complaint.',
      ...
      'menu.select_variant': 'Choose size or weight',
      ...
      'cart.delivery_address_hint': 'Pick delivery address from the map only',
      ...
      'cart.discount_section': 'Discount Code',
      'cart.discount_code_label': 'Discount code',
      'cart.discount_code_hint': 'Example: SAVE10',
      'cart.discount_apply': 'Apply',
      'cart.discount_remove': 'Remove code',
      'cart.discount_type': 'Discount type: {type}',
      'cart.discount_type_percentage': 'Percentage',
      'cart.discount_type_fixed': 'Fixed amount',
      'cart.discount_before': 'Price before discount',
      'cart.discount_value': 'Discount value',
      'cart.discount_final': 'Final price',
      'cart.discount_apply_success': 'Code {code} applied successfully.',
      'cart.discount_empty_code': 'Enter a discount code first.',
      'cart.discount_invalid_or_expired': 'Code is invalid or expired.',
      'cart.discount_min_order_not_met':
          'Minimum order required for this code is {minimum}.',
      'cart.discount_invalid_amount':
          'Discount configuration for this code is invalid.',
      'cart.discount_already_applied': 'This code is already applied.',
      'cart.discount_single_code_only':
          'Only one discount code can be applied. Remove the current code first.',
      'cart.discount_removed_min_order':
          'Discount code was removed because minimum order is {minimum}.',
      'cart.discount_error_generic':
          'Unable to validate discount code right now. Please try again.',
      'cart.discount_locked':
          'You cannot apply a discount code while an order is active.',
