...
void main() {
  group('resolveOrderStatus', () {
    test('maps server status aliases to the expected stage', () {
      ...
      expect(parseOrderStatus('delivered'), OrderStatusStage.completed);
    ...
    test('exposes tracking flags consistently', () {
      ...
      expect(orderStatusInfo(OrderStatusStage.onTheWay).shouldTrackDriver, isTrue);
      expect(orderStatusInfo(OrderStatusStage.completed).trackingProgressIndex, 3);
